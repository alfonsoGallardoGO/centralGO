    ...
    <AppLayout title="Usuarios">
        <div class="card">
            ...
            >
                ...
                ></Column>
                <Column header="RFC" sortable style="min-width: 16rem">
                    <template #body="slotProps">
                        <Tag
                            icon="pi pi-user"
                            severity="info"
            ...
            <div class="flex flex-col gap-6">
                <div>
                    ...
                    <img
                        ...
                        style="width: 100px; height: 100px"
                    />
                    <label for="profile_photo_path" class="block font-bold mb-3"
                    ...
                    <InputText
                        ...
                        fluid
                    />
                    <small v-if="!user.name && submitted" class="text-red-500"
                ...
                <div>
                    ...
                    />
                    <small
                        v-if="(submitted && !user.rfc) || page.props.errors.rfc"
                        class="text-red-500"
                        >{{
                ...
                <div>
                    <span class="block font-bold mb-4">Nombre de usuario</span>
                    <InputText
                        id="username"
                ...
                <div>
                    <label for="supplier_id" class="block font-bold mb-3"
                        >Proveedor</label
                    >
                    <Select
